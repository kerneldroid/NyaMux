...
import com.nyamux.view.textselection.TextSelectionCursorController
...
class TerminalView @JvmOverloads constructor(
     ...
     * {@link com.nyamux.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    override fun onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.nyamux.app.TermuxActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode()
