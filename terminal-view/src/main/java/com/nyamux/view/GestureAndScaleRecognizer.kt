...
internal class GestureAndScaleRecognizer(context: Context, listener: Listener) {
    ...
    @JvmField
    internal val mListener: Listener = listener

    @JvmField
    internal var isAfterLongPress: Boolean = false
