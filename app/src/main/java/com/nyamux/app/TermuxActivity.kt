...
import com.nyamux.app.api.file.FileReceiverActivity
import com.nyamux.app.compose.ContextMenuStateHolder
import com.nyamux.app.compose.MainScreenStateHolder
import com.nyamux.app.compose.setMainContent
import com.nyamux.app.compose.ComposeExtraKeysView
import com.nyamux.app.terminal.TermuxActivityRootView
import com.nyamux.app.terminal.TermuxTerminalSessionActivityClient
import com.nyamux.app.terminal.io.TermuxTerminalExtraKeys
import com.nyamux.app.terminal.TermuxTerminalViewClient
import com.nyamux.shared.activities.ReportActivity
import com.nyamux.shared.activity.ActivityUtils
...
import com.nyamux.shared.termux.crash.TermuxCrashUtils
...
import com.nyamux.shared.termux.theme.TermuxThemeUtils
import com.nyamux.shared.theme.NightMode
import com.nyamux.shared.view.ViewUtils
            ...
            if (PermissionUtils.checkAndRequestLegacyOrManageExternalStoragePermission(
                ...
                if (isPermissionCallback) {
                    Logger.logInfoAndShowToast(
                        ...
                        getString(com.nyamux.shared.R.string.msg_storage_permission_granted_on_request)
                    )
                }
                ...
                if (isPermissionCallback) {
                    Logger.logInfoAndShowToast(
                        this@TermuxActivity, LOG_TAG,
                        getString(com.nyamux.shared.R.string.msg_storage_permission_not_granted_on_request)
                    )
                }
            }
        }.start()
