...
import com.nyamux.shared.termux.terminal.io.BellHandler
import com.nyamux.terminal.TerminalColors
import com.nyamux.terminal.TerminalSession
import com.nyamux.terminal.TextStyle
import java.io.File
import java.io.FileInputStream
import java.util.Properties

/** The [com.nyamux.terminal.TerminalSessionClient] implementation that may require an [android.app.Activity] for its interface methods. */
class TermuxTerminalSessionActivityClient(private val mActivity: TermuxActivity) : TermuxTerminalSessionClientBase() {
    ...
    private fun loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool!!.load(mActivity, com.nyamux.shared.R.raw.bell, 1)
            } catch (e: Exception) {
                // Catch java.lang.RuntimeException: Unable to resume activity {com.nyamux/com.nyamux.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
