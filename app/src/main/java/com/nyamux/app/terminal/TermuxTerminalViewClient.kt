...
import com.nyamux.app.terminal.io.KeyboardShortcut
...
import com.nyamux.shared.termux.TermuxBootstrap
import com.nyamux.shared.termux.TermuxConstants
import com.nyamux.shared.termux.TermuxUtils
import com.nyamux.shared.termux.data.TermuxUrlUtils
import com.nyamux.shared.termux.extrakeys.SpecialButton
import com.nyamux.shared.termux.settings.properties.TermuxPropertyConstants
import com.nyamux.shared.termux.terminal.TermuxTerminalViewClientBase
import com.nyamux.shared.view.KeyboardUtils
import com.nyamux.shared.view.ViewUtils
import com.nyamux.terminal.KeyHandler
...
open class TermuxTerminalViewClient(
    ...
    /**
     * Should be called when {@link com.nyamux.view.TerminalView#mEmulator} is set
     */
    ...
    fun reportIssueFromTranscript() {
        ...
        MessageDialogUtils.showMessage(
            ...
            mActivity.getString(com.nyamux.shared.R.string.action_yes),
            { _, _ -> reportIssueFromTranscript(transcriptText, true) },
            mActivity.getString(com.nyamux.shared.R.string.action_no),
