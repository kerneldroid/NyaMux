...
import com.nyamux.shared.termux.file.TermuxFileUtils
import com.nyamux.shared.file.filesystem.FileType
import com.nyamux.shared.errors.Errno
import com.nyamux.shared.errors.Error
import com.nyamux.shared.termux.TermuxConstants
import com.nyamux.shared.termux.TermuxConstants.TERMUX_APP.RUN_COMMAND_SERVICE
...
class RunCommandService : Service() {
    ...
    inner class LocalBinder : Binder() {
        val service: RunCommandService
            get() = this@RunCommandService
    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        */
        ...
        if (!executionCommand.workingDirectory.isNullOrEmpty()) {
            ...
            val dirError = TermuxFileUtils.validateDirectoryFileExistenceAndPermissions("working", executionCommand.workingDirectory,
                true, true, true,
                false, true)
            if (dirError != null) {
                executionCommand.setStateFailed(dirError)
                TermuxPluginUtils.processPluginExecutionCommandError(this, LOG_TAG, executionCommand, false)
                return stopService()
            }
        }
    ...
    private fun buildNotification(): Notification? {
        ...
        val builder = NotificationUtils.geNotificationBuilder(this,
            ...
            null, null, NotificationUtils.NOTIFICATION_MODE_SILENT) ?: return null
