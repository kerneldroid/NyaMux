package com.nyamux.shared.activities
 ...
 * `<activity android:name="com.nyamux.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />`
 * and
 * `<receiver android:name="com.nyamux.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />`
...
class ReportActivity : AppCompatActivity() {
    ...
    companion object {
        private val CLASS_NAME: String = ReportActivity::class.java.canonicalName ?: "com.nyamux.shared.activities.ReportActivity"
