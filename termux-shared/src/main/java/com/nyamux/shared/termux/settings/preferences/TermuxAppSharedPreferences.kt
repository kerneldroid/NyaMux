...
class TermuxAppSharedPreferences private constructor(context: Context) : AppSharedPreferences(
    ...
    fun shouldShowTerminalToolbar(): Boolean {
        return SharedPreferenceUtils.getBoolean(
            mSharedPreferences,
            TERMUX_APP.KEY_SHOW_TERMINAL_TOOLBAR,
    ...
    fun isSoftKeyboardEnabled(): Boolean {
        return SharedPreferenceUtils.getBoolean(
            mSharedPreferences,
            TERMUX_APP.KEY_SOFT_KEYBOARD_ENABLED,
    ...
    fun setLogLevel(context: Context, logLevel: Int) {
        ...
        SharedPreferenceUtils.setInt(mSharedPreferences, TERMUX_APP.KEY_LOG_LEVEL, updatedLogLevel, false)
    }

    var lastNotificationId: Int
        get() = SharedPreferenceUtils.getInt(
            mSharedPreferences,
            TERMUX_APP.KEY_LAST_NOTIFICATION_ID,
    ...
    fun getAndIncrementAppShellNumberSinceBoot(): Int {
        ...
        return SharedPreferenceUtils.getAndIncrementInt(
            mSharedPreferences,
            TERMUX_APP.KEY_APP_SHELL_NUMBER_SINCE_BOOT,
            TERMUX_APP.DEFAULT_VALUE_APP_SHELL_NUMBER_SINCE_BOOT,
            true,
            Int.MAX_VALUE
        )
    }
    ...
    fun getAndIncrementTerminalSessionNumberSinceBoot(): Int {
        ...
        return SharedPreferenceUtils.getAndIncrementInt(
            ...
            TERMUX_APP.DEFAULT_VALUE_TERMINAL_SESSION_NUMBER_SINCE_BOOT,
            true,
            Int.MAX_VALUE
        )
    }
    ...
    fun isTerminalViewKeyLoggingEnabled(): Boolean {
        return SharedPreferenceUtils.getBoolean(
            mSharedPreferences,
            TERMUX_APP.KEY_TERMINAL_VIEW_KEY_LOGGING_ENABLED,
    ...
    companion object {
        ...
        fun build(context: Context): TermuxAppSharedPreferences? {
            ...
            return if (termuxPackageContext == null) null else TermuxAppSharedPreferences(termuxPackageContext)
        }
