...
import com.nyamux.shared.termux.settings.preferences.TermuxPreferenceConstants.TERMUX_FLOAT_APP
...
class TermuxFloatAppSharedPreferences private constructor(context: Context) : AppSharedPreferences(
    ...
    fun getLogLevel(readFromFile: Boolean): Int {
        return if (readFromFile) {
            SharedPreferenceUtils.getInt(
                ...
                TERMUX_FLOAT_APP.KEY_LOG_LEVEL,
    ...
    companion object {
         ...
         * @return Returns the [TermuxFloatAppSharedPreferences]. This will `null` if an exception is raised.
         */
        @JvmStatic
