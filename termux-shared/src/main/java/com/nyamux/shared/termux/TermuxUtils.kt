...
import com.nyamux.shared.reflection.ReflectionUtils
...
class TermuxUtils {
    ...
    companion object {
         ...
         *
         * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.nyamux`
         * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
         * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.nyamux/......} BLOCKED`
         ...
         * <manifest>
         *     <queries>
         *         <package android:name="com.nyamux" />
         *    </queries>
         * </manifest>
         * ```
         *
