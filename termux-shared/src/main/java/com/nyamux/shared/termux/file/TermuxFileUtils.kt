package com.nyamux.shared.termux.file
...
import com.nyamux.shared.file.FileUtilsErrno
...
object TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/com.nyamux` as secondary user will result
     * in `ls: /data/user/0/com.nyamux: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/com.nyamux` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/com.nyamux` where `10` is
