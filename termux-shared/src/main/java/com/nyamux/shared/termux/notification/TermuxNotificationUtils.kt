package com.nyamux.shared.termux.notification
...
import com.nyamux.shared.android.resource.ResourceUtils
...
object TermuxNotificationUtils {
    ...
    fun getNextNotificationId(context: Context?): Int {
        ...
        val lastNotificationId = preferences.lastNotificationId
        ...
        preferences.lastNotificationId = nextNotificationId
    ...
    fun getTermuxOrPluginAppNotificationBuilder(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            val iconResId = termuxPackageContext?.let {
                ResourceUtils.getDrawableResourceId(
                    it, "ic_error_notification",
                    it.packageName, true
                )
            }
            if (iconResId != null) {
