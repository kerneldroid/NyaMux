package com.nyamux.shared.shell.command.runner.app
...
import com.nyamux.shared.shell.StreamGobbler
import com.nyamux.shared.shell.command.ExecutionCommand
import com.nyamux.shared.shell.command.ExecutionCommand.ExecutionState
import com.nyamux.shared.shell.command.environment.IShellEnvironment
...
class AppShell private constructor(
     ...
     *
     * If the processes finishes, then sets [com.nyamux.shared.shell.command.result.ResultData.stdout],
     * [com.nyamux.shared.shell.command.result.ResultData.stderr] and [com.nyamux.shared.shell.command.result.ResultData.exitCode]
